...
|
*/
$config['base_url'] = 'https://dummy.keliechem.com/';
//$http = 'http' . ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') ? 's' : '') . '://';
//$newurl = str_replace("index.php","", $_SERVER['SCRIPT_NAME']);
//$config['base_url']    = "$http" . $_SERVER['SERVER_NAME'] . ":80" . $newurl;
...
$config['index_page'] = ''; //untuk menghilangkan nama index.php di halaman dengan cara hapus nama index.php
