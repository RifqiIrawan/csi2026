...
<body class="index-page">
  ...
  <main class="main">
    ...
    <section id="about" class="portfolio section">
      ...
      ?> 
      <div class="col-xl-12 d-flex flex-column justify-content-center container section-title heading_style4 center">
        <h2><?php echo $exp[0];?><span>&nbsp; <?php echo $exp[1];?></span></h2>
      ...
      <div class="container">
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          <div class="row gy-4 isotope-container">
            <?php 
              // $dir = $row3->folder_name;
              // $files = scandir($dir);
              // $filecount = count($files);
              // for ($i=0; $i <= $filecount ; $i++) { 
              //   if ($files[$i] != '.' && $files[$i] != '..') {
            ?>
            <!-- <div class="col-lg-2 col-md-3 portfolio-item isotope-item filter-app" style="height:180px">
              <div class="portfolio-content h-100">
                <a href="<?php echo $row2->url ?>" class="stretched-link" target="_blank"></a>
                <img src="<?php echo $dir.$files[$i] ?>" class="img-fluid" alt="" style="height: 180;">                    
              </div>
            </div> -->
            <?php             
              //   }
            ...
            <div class="col-lg-3 col-md-1 portfolio-item isotope-item filter-app">
              <div class="portfolio-content h-100">
                <a href="<?php echo $row2->url ?>" class="stretched-link" target="_blank"></a>
                <img src="<?php echo base_url($img2); ?>" class="img-fluid con_partner img-partner" alt="<?php echo $row2->nama ?>">
              </div>
				
              <div class="portfolio-content h-100 text-center mt-2">
    ...
    <section id="product" class="portfolio section">
      <div class="container section-title heading_style4 center" data-aos="fade-up">
        <div class="description-title">Our Products and Services</div>
